...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        # --------------------------------------------------------------
        hul=rg.Point((intersection_center.x-(width/2)),
                     (intersection_center.y-(letter_thickness/2)))
        ulr=rg.Point((intersection_center.x+(width/2)),
                     (intersection_center.y+(letter_thickness/2)))
        vul=rg.Point((intersection_center.x-(letter_thickness/2)),
                      (intersection_center.y-(letter_thickness/2)))
        vlr=rg.Point((intersection_center.x+(letter_thickness/2)),
                     (intersection_center.y+height))
        self.h_rect=rg.Rectangle(hul,ulr)
        self.v_rect=rg.Rectangle(vul,vlr)
    ...
    def clone(self):
        ...
        #     clone.pdf.
        # --------------------------------------------------------------
        t= CapitalT(self.intersection_center,self.width,self.height,self.thickness)
